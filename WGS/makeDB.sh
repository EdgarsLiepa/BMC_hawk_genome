...
# --- Date: 19.10.22
# --- Last revison: 20.02.22


#!/bin/bash
#PBS -N createVanagiDB
#PBS -l nodes=wn61:ppn=24,mem=800g
...
DBPath='/home_beegfs/edgars01/Ineta/WGS/starpfaili/DB'
#Temporary dir
TMP='/home_beegfs/groups/bmc/tmp/ditagu'
 
export _JAVA_OPTIONS=-Djava.io.tmpdir=/home_beegfs/edgars01/Ineta/WGS/tmp
/home_beegfs/edgars01/tools/gatk-4.2.6.1/gatk --java-options "-Xms64G -Xmx700g -XX:ParallelGCThreads=24" GenomicsDBImport \
...
--genomicsdb-workspace-path ${DBPath}/gatk_database_vanagi \
--tmp-dir ${TMP} \
-L ${FILEPATH}/intervals.list \
--reader-threads 24;
 
chmod u=rwx,g=rx,o=r ${DBPath}/gatk_database_vanagi;
